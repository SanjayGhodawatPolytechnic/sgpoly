...
const UpdatesCard = ({
    ...
    return (
        <div classNameName="card mb-3 " style={{borderRadius: 10}} >
            {didRedirect && (<PerformRedirect />)}
                    <div className="row ">
                        ...
                        <svg className="bi bi-trash-fill m-5" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
