      ...
      <div class="row">
        <div class="col-sm-3 ">
          <div class="card admincard">
            <div class="card-body">
              <h5 class="card-title">Mr. Vinayak Bhosale</h5>
              <p class="card-text">
                Trustee - SGI
        ...
        <div class="col-sm-3">
          <div class="card admincard">
            <div class="card-body">
              <h5 class="card-title">Mr. Virat Giri</h5>
              <p class="card-text">
                Principal
        ...
        <div class="col-sm-3">
          <div class="card admincard">
            <div class="card-body">
              <h5 class="card-title">Mr. Pratik Awati</h5>
              <p class="card-text">
                Admission Incharge
        ...
        <div class="col-sm-3">
          <div class="card admincard">
            <div class="card-body">
              <h5 class="card-title">Mr. Abhijeet Kulkarni</h5>
              <p class="card-text">
