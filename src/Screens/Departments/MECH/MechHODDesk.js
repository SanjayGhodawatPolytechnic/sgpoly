            ...
            data-offset="0">
                <div className="row">
                    <div className="col text-center">
                        <img alt="etc hod" className="img-fluid rounded" src='http://sgipolytechnic.in/Images/HOD_Mech.jpg' />
                    </div>
                    <div className="col-12 text-center"><b>Mr. Kumbar Raju Basappa</b></div>
